...
var mostrar_rendimento = (cdi,saldo)=>{
    ...
    return document.querySelector(".resposta").innerHTML= "seu dinheiro está rendendo " + rendimento.tofixed(2).toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'}).replace('.', ',') + " ao mês.";
}
